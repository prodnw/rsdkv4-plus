        ...
        case MULTIPLAYERSCREEN_STATE_MAIN: {
            ...
            if (usePhysicalControls) {
                if (touches > 0) {
                    ...
                    else if (keyPress[0].B || self->backPressed) {
        ...
        case MULTIPLAYERSCREEN_STATE_HOSTSCR: {
            ...
            if (usePhysicalControls) {
                if (touches > 0) {
                    ...
                    if (keyPress[0].A || keyPress[0].start) {
                        PlaySfxByName("Menu Select", false);
                        char buffer[0x30];
                        int code = GetRoomCode();
                        sprintf(buffer, "%08X", code);
                ...
                if (touches > 0) {
                    ...
                    self->buttons[MULTIPLAYERSCREEN_BUTTON_COPY]->state |= keyPress[0].A || keyPress[0].start;
