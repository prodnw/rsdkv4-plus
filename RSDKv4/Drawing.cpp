...
void DrawTextMenuEntryFX(void *menu, int rowID, int XPos, int YPos, int textHighlight, int direction, int scaleX, int scaleY, int rotation, int alpha, int effect)
{
    TextMenu *tMenu = (TextMenu *)menu;
    int id          = tMenu->entryStart[rowID];
    for (int i = 0; i < tMenu->entrySize[rowID]; ++i) {
        ...
        DrawSpriteAllFX(direction, xDrawPos, YPos, 0, 0, sprX, sprY, 8, 8, rotation, scaleX, scaleY, textMenuSurfaceNo, alpha, effect, FX_ALL);
...
void DrawStageTextEntryFX(void *menu, int rowID, int XPos, int YPos, int textHighlight, int direction, int scaleX, int scaleY, int rotation, int alpha, int effect)
{
    TextMenu *tMenu = (TextMenu *)menu;
    int id          = tMenu->entryStart[rowID];
    for (int i = 0; i < tMenu->entrySize[rowID]; ++i) {
...
void DrawTextMenuFX(void *menu, int XPos, int YPos, int direction, int scaleX, int scaleY, int rotation, int alpha, int effect)
{
    TextMenu *tMenu = (TextMenu *)menu;
    int cnt         = 0;
        ...
        case 0:
            for (int i = (int)tMenu->visibleRowOffset; i < cnt; ++i) {
                switch (tMenu->selectionCount) {
                    case 1:
                        if (i == tMenu->selection1)
                            DrawTextMenuEntryFX(tMenu, i, XPos, YPos, 128, direction, scaleX, scaleY, rotation, alpha, effect);
                        else
                            DrawTextMenuEntryFX(tMenu, i, XPos, YPos, 0, direction, scaleX, scaleY, rotation, alpha, effect);
                        break;
                    ...
                    case 3:
                        ...
                        if (i == tMenu->selection2 && i != tMenu->selection1)
                            DrawStageTextEntryFX(tMenu, i, XPos, YPos, 128, direction, scaleX, scaleY, rotation, alpha, effect);
                        break;
                }
                YPos += 8;
            }
        ...
        case 1:
            for (int i = (int)tMenu->visibleRowOffset; i < cnt; ++i) {
                ...
                switch (tMenu->selectionCount) {
                    case 1:
                        if (i == tMenu->selection1)
                            DrawTextMenuEntryFX(tMenu, i, entryX, YPos, 128, direction, scaleX, scaleY, rotation, alpha, effect);
                        else
                            DrawTextMenuEntryFX(tMenu, i, entryX, YPos, 0, direction, scaleX, scaleY, rotation, alpha, effect);
                        break;
                    ...
                    case 3:
                        ...
                        if (i == tMenu->selection2 && i != tMenu->selection1)
                            DrawStageTextEntryFX(tMenu, i, entryX, YPos, 128, direction, scaleX, scaleY, rotation, alpha, effect);
                        break;
                }
                YPos += 8;
            }
